...
; set_to true
(assert (forall ((|ς| state)) (=> (S45 |ς|) (S46 (enter-scope-state-p64 |ς| (object-address "main::$tmp::return_value_cstrcspn") (_ bv8 64))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S47 |ς|) (S48 (enter-scope-state-p64 |ς| (object-address "cstrcspn::s1") (_ bv8 64))))))

; find_symbols
(declare-fun S49 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S48 |ς|) (S49 (update-state-p64 |ς| (object-address "cstrcspn::s1") (evaluate-p64 |ς| (object-address "main::1::nondetString1")))))))

; find_symbols
(declare-fun S50 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S49 |ς|) (S50 (enter-scope-state-p64 |ς| (object-address "cstrcspn::s2") (_ bv8 64))))))

; find_symbols
(declare-fun S51 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S50 |ς|) (S51 (update-state-p64 |ς| (object-address "cstrcspn::s2") (evaluate-p64 |ς| (object-address "main::1::nondetString2")))))))

; find_symbols
(declare-fun S52 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S51 |ς|) (S52 (enter-scope-state-p64 |ς| (object-address "cstrcspn::1::p") (_ bv8 64))))))

; find_symbols
(declare-fun S53 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S52 |ς|) (S53 (enter-scope-state-p64 |ς| (object-address "cstrcspn::1::spanp") (_ bv8 64))))))

; find_symbols
(declare-fun S54 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S53 |ς|) (S54 (enter-scope-state-p64 |ς| (object-address "cstrcspn::1::c") (_ bv1 64))))))

; find_symbols
(declare-fun S55 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S54 |ς|) (S55 (enter-scope-state-p64 |ς| (object-address "cstrcspn::1::sc") (_ bv1 64))))))

; find_symbols
(declare-fun S56 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S55 |ς|) (S56 (update-state-p64 |ς| (object-address "cstrcspn::1::p") (evaluate-p64 |ς| (object-address "cstrcspn::s1")))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S83 |ς|) (S57in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (and (S57in |ς|) false) (S57T |ς|))))

; find_symbols
(declare-fun S57 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S57in |ς|) (not false)) (S57 |ς|))))

; find_symbols
(declare-fun S58 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S57 |ς|) (S58 (enter-scope-state-p64 |ς| (object-address "cstrcspn::$tmp::tmp_post_p") (_ bv8 64))))))

; find_symbols
(declare-fun S59 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S58 |ς|) (S59 (update-state-p64 |ς| (object-address "cstrcspn::$tmp::tmp_post_p") (evaluate-p64 |ς| (object-address "cstrcspn::1::p")))))))

; find_symbols
(declare-fun S60 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S59 |ς|) (S60 (update-state-p64 |ς| (object-address "cstrcspn::1::p") (bvadd (evaluate-p64 |ς| (object-address "cstrcspn::1::p")) (_ bv1 64)))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S61 |ς|) (S62 (update-state-s8 |ς| (object-address "cstrcspn::1::c") (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrcspn::$tmp::tmp_post_p"))))))))

; find_symbols
(declare-fun S63 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S62 |ς|) (S63 (update-state-p64 |ς| (object-address "cstrcspn::1::spanp") (evaluate-p64 |ς| (object-address "cstrcspn::s2")))))))

; find_symbols
(declare-fun S79T (state) Bool)
; find_symbols
(declare-fun S64in (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S79T |ς|) (S64in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S64in |ς|) (S64 (enter-scope-state-p64 |ς| (object-address "cstrcspn::$tmp::tmp_post_spanp") (_ bv8 64))))))

; find_symbols
(declare-fun S65 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S64 |ς|) (S65 (update-state-p64 |ς| (object-address "cstrcspn::$tmp::tmp_post_spanp") (evaluate-p64 |ς| (object-address "cstrcspn::1::spanp")))))))

; find_symbols
(declare-fun S66 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S65 |ς|) (S66 (update-state-p64 |ς| (object-address "cstrcspn::1::spanp") (bvadd (evaluate-p64 |ς| (object-address "cstrcspn::1::spanp")) (_ bv1 64)))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S67 |ς|) (S68 (update-state-s8 |ς| (object-address "cstrcspn::1::sc") (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrcspn::$tmp::tmp_post_spanp"))))))))

; find_symbols
(declare-fun S69T (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S68 |ς|) (not (= (evaluate-s8 |ς| (object-address "cstrcspn::1::sc")) (evaluate-s8 |ς| (object-address "cstrcspn::1::c"))))) (S69T |ς|))))

; find_symbols
(declare-fun S69 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S68 |ς|) (= (evaluate-s8 |ς| (object-address "cstrcspn::1::sc")) (evaluate-s8 |ς| (object-address "cstrcspn::1::c")))) (S69 |ς|))))

; find_symbols
(declare-fun S70 (state) Bool)
(declare-fun update-state-u64 (state (_ BitVec 64) (_ BitVec 64)) state)
; set_to true
(assert (forall ((|ς| state)) (=> (S69 |ς|) (S70 (update-state-u64 |ς| (object-address "main::$tmp::return_value_cstrcspn") (bvsub (bvadd (evaluate-p64 |ς| (object-address "cstrcspn::1::p")) (bvneg ((_ sign_extend 32) (_ bv1 32)))) (evaluate-p64 |ς| (object-address "cstrcspn::s1"))))))))

; find_symbols
(declare-fun S71 (state) Bool)
(declare-fun exit-scope-state-p64 (state (_ BitVec 64)) state)
; set_to true
(assert (forall ((|ς| state)) (=> (S70 |ς|) (S71 (exit-scope-state-p64 |ς| (object-address "cstrcspn::$tmp::tmp_post_p"))))))

; find_symbols
(declare-fun S72 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S71 |ς|) (S72 (exit-scope-state-p64 |ς| (object-address "cstrcspn::1::sc"))))))

; find_symbols
(declare-fun S73 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S72 |ς|) (S73 (exit-scope-state-p64 |ς| (object-address "cstrcspn::1::c"))))))

; find_symbols
(declare-fun S74 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S73 |ς|) (S74 (exit-scope-state-p64 |ς| (object-address "cstrcspn::1::spanp"))))))

; find_symbols
(declare-fun S75 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S74 |ς|) (S75 (exit-scope-state-p64 |ς| (object-address "cstrcspn::1::p"))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S77 |ς|) (S78 (exit-scope-state-p64 |ς| (object-address "cstrcspn::$tmp::tmp_post_spanp"))))))

; set_to true
(assert (forall ((|ς| state)) (=> (and (S78 |ς|) (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "cstrcspn::1::sc"))) (_ bv0 32)))) (S79T |ς|))))

; find_symbols
(declare-fun S79 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S78 |ς|) (not (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "cstrcspn::1::sc"))) (_ bv0 32))))) (S79 |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S80 |ς|) (S81 (exit-scope-state-p64 |ς| (object-address "cstrcspn::$tmp::tmp_post_p"))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S84 |ς|) (S85 (exit-scope-state-p64 |ς| (object-address "cstrcspn::1::sc"))))))

; find_symbols
(declare-fun S86 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S85 |ς|) (S86 (exit-scope-state-p64 |ς| (object-address "cstrcspn::1::c"))))))

; find_symbols
(declare-fun S87 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S86 |ς|) (S87 (exit-scope-state-p64 |ς| (object-address "cstrcspn::1::spanp"))))))

; find_symbols
(declare-fun S88 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S87 |ς|) (S88 (exit-scope-state-p64 |ς| (object-address "cstrcspn::1::p"))))))

; find_symbols
(declare-fun S89 (state) Bool)
; set_to true
(assert (forall ((|ς| state) (|nondet::S89-0| (_ BitVec 64))) (=> (S88 |ς|) (S89 (update-state-u64 |ς| (object-address "main::$tmp::return_value_cstrcspn") |nondet::S89-0|)))))

; find_symbols
(declare-fun S90in (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S76 |ς|) (S90in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S90 |ς|) (S91 (exit-scope-state-p64 |ς| (object-address "cstrcspn::s1"))))))

; find_symbols
(declare-fun S92 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S91 |ς|) (S92 (exit-scope-state-p64 |ς| (object-address "cstrcspn::s2"))))))

; find_symbols
(declare-fun S93 (state) Bool)
(declare-fun evaluate-u64 (state (_ BitVec 64)) (_ BitVec 64))
; set_to true
(assert (forall ((|ς| state)) (=> (S92 |ς|) (S93 (update-state-s8 |ς| (object-address "return'") ((_ extract 7 0) (evaluate-u64 |ς| (object-address "main::$tmp::return_value_cstrcspn"))))))))

; find_symbols
(declare-fun S94 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S93 |ς|) (S94 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value_cstrcspn"))))))

; find_symbols
(declare-fun S95 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S94 |ς|) (S95 (exit-scope-state-p64 |ς| (object-address "main::1::nondetString2"))))))

; find_symbols
(declare-fun S96 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S95 |ς|) (S96 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value_malloc$0"))))))

; find_symbols
(declare-fun S97 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S96 |ς|) (S97 (exit-scope-state-p64 |ς| (object-address "main::1::nondetString1"))))))

; find_symbols
(declare-fun S98 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S97 |ς|) (S98 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value_malloc"))))))

; find_symbols
(declare-fun S99 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S98 |ς|) (S99 (exit-scope-state-p64 |ς| (object-address "main::1::length2"))))))

; find_symbols
(declare-fun S100 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S99 |ς|) (S100 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value___VERIFIER_nondet_char$0"))))))

; find_symbols
(declare-fun S101 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S100 |ς|) (S101 (exit-scope-state-p64 |ς| (object-address "main::1::length1"))))))

; find_symbols
(declare-fun S102 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S101 |ς|) (S102 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value___VERIFIER_nondet_char"))))))
