...
; set_to true
(assert (forall ((|ς| state)) (=> (S31 |ς|) (S32 (enter-scope-state-p64 |ς| (object-address "bubbleSort::numbers") (_ bv8 64))))))

; find_symbols
(declare-fun S33 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S32 |ς|) (S33 (update-state-p64 |ς| (object-address "bubbleSort::numbers") (evaluate-p64 |ς| (object-address "main::1::numbers")))))))

; find_symbols
(declare-fun S34 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S33 |ς|) (S34 (enter-scope-state-p64 |ς| (object-address "bubbleSort::array_size") (_ bv1 64))))))

; find_symbols
(declare-fun S35 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S34 |ς|) (S35 (update-state-s8 |ς| (object-address "bubbleSort::array_size") (evaluate-s8 |ς| (object-address "main::1::array_size")))))))

; find_symbols
(declare-fun S36 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S35 |ς|) (S36 (enter-scope-state-p64 |ς| (object-address "bubbleSort::1::i") (_ bv1 64))))))

; find_symbols
(declare-fun S37 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S36 |ς|) (S37 (enter-scope-state-p64 |ς| (object-address "bubbleSort::1::j") (_ bv1 64))))))

; find_symbols
(declare-fun S38 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S37 |ς|) (S38 (enter-scope-state-p64 |ς| (object-address "bubbleSort::1::temp") (_ bv1 64))))))

; find_symbols
(declare-fun S39 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S38 |ς|) (S39 (update-state-s8 |ς| (object-address "bubbleSort::1::i") ((_ extract 7 0) (bvsub ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "bubbleSort::array_size"))) (_ bv1 32))))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S58 |ς|) (S40in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (and (S40in |ς|) (not (bvsge ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "bubbleSort::1::i"))) (_ bv0 32)))) (S40T |ς|))))

; find_symbols
(declare-fun S40 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S40in |ς|) (bvsge ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "bubbleSort::1::i"))) (_ bv0 32))) (S40 |ς|))))

; find_symbols
(declare-fun S41 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S40 |ς|) (S41 (update-state-s8 |ς| (object-address "bubbleSort::1::j") ((_ extract 7 0) (_ bv1 32)))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S55 |ς|) (S42in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (and (S42in |ς|) (not (bvsle ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "bubbleSort::1::j"))) ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "bubbleSort::1::i")))))) (S42T |ς|))))

; find_symbols
(declare-fun S42 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S42in |ς|) (bvsle ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "bubbleSort::1::j"))) ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "bubbleSort::1::i"))))) (S42 |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (and (S44 |ς|) (not (bvsgt ((_ sign_extend 24) (evaluate-s8 |ς| (bvadd (evaluate-p64 |ς| (object-address "bubbleSort::numbers")) ((_ sign_extend 32) (bvsub ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "bubbleSort::1::j"))) (_ bv1 32)))))) ((_ sign_extend 24) (evaluate-s8 |ς| (bvadd (evaluate-p64 |ς| (object-address "bubbleSort::numbers")) ((_ sign_extend 56) (evaluate-s8 |ς| (object-address "bubbleSort::1::j"))))))))) (S45T |ς|))))

; find_symbols
(declare-fun S45 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S44 |ς|) (bvsgt ((_ sign_extend 24) (evaluate-s8 |ς| (bvadd (evaluate-p64 |ς| (object-address "bubbleSort::numbers")) ((_ sign_extend 32) (bvsub ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "bubbleSort::1::j"))) (_ bv1 32)))))) ((_ sign_extend 24) (evaluate-s8 |ς| (bvadd (evaluate-p64 |ς| (object-address "bubbleSort::numbers")) ((_ sign_extend 56) (evaluate-s8 |ς| (object-address "bubbleSort::1::j")))))))) (S45 |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S46 |ς|) (S47 (update-state-s8 |ς| (object-address "bubbleSort::1::temp") (evaluate-s8 |ς| (bvadd (evaluate-p64 |ς| (object-address "bubbleSort::numbers")) ((_ sign_extend 32) (bvsub ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "bubbleSort::1::j"))) (_ bv1 32))))))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S49 |ς|) (S50 (update-state-s8 |ς| (bvadd (evaluate-p64 |ς| (object-address "bubbleSort::numbers")) ((_ sign_extend 32) (bvsub ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "bubbleSort::1::j"))) (_ bv1 32)))) (evaluate-s8 |ς| (bvadd (evaluate-p64 |ς| (object-address "bubbleSort::numbers")) ((_ sign_extend 56) (evaluate-s8 |ς| (object-address "bubbleSort::1::j"))))))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S51 |ς|) (S52 (update-state-s8 |ς| (bvadd (evaluate-p64 |ς| (object-address "bubbleSort::numbers")) ((_ sign_extend 56) (evaluate-s8 |ς| (object-address "bubbleSort::1::j")))) (evaluate-s8 |ς| (object-address "bubbleSort::1::temp")))))))

; find_symbols
(declare-fun S53in (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S45T |ς|) (S53in |ς|))))

; set_to true
(assert (forall ((|ς| state)) (=> (S52 |ς|) (S53in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S53 |ς|) (S54 (update-state-s8 |ς| (object-address "bubbleSort::1::j") (bvadd (evaluate-s8 |ς| (object-address "bubbleSort::1::j")) (_ bv1 8)))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S56 |ς|) (S57 (update-state-s8 |ς| (object-address "bubbleSort::1::i") (bvsub (evaluate-s8 |ς| (object-address "bubbleSort::1::i")) (_ bv1 8)))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S59 |ς|) (S60 (exit-scope-state-p64 |ς| (object-address "bubbleSort::1::temp"))))))

; find_symbols
(declare-fun S61 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S60 |ς|) (S61 (exit-scope-state-p64 |ς| (object-address "bubbleSort::1::j"))))))

; find_symbols
(declare-fun S62 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S61 |ς|) (S62 (exit-scope-state-p64 |ς| (object-address "bubbleSort::1::i"))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S63 |ς|) (S64 (exit-scope-state-p64 |ς| (object-address "bubbleSort::numbers"))))))

; find_symbols
(declare-fun S65 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S64 |ς|) (S65 (exit-scope-state-p64 |ς| (object-address "bubbleSort::array_size"))))))
