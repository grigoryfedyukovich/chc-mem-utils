...
; set_to true
(assert (forall ((|ς| state)) (=> (S63 |ς|) (S64 (enter-scope-state-p64 |ς| (object-address "cstrncat::s1") (_ bv8 64))))))

; find_symbols
(declare-fun S65 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S64 |ς|) (S65 (update-state-p64 |ς| (object-address "cstrncat::s1") (evaluate-p64 |ς| (object-address "main::1::nondetString1")))))))

; find_symbols
(declare-fun S66 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S65 |ς|) (S66 (enter-scope-state-p64 |ς| (object-address "cstrncat::s2") (_ bv8 64))))))

; find_symbols
(declare-fun S67 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S66 |ς|) (S67 (update-state-p64 |ς| (object-address "cstrncat::s2") (evaluate-p64 |ς| (object-address "main::1::nondetString2")))))))

; find_symbols
(declare-fun S68 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S67 |ς|) (S68 (enter-scope-state-p64 |ς| (object-address "cstrncat::n") (_ bv1 64))))))

; find_symbols
(declare-fun S69 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S68 |ς|) (S69 (update-state-s8 |ς| (object-address "cstrncat::n") (evaluate-s8 |ς| (object-address "main::1::n")))))))

; find_symbols
(declare-fun S70 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S69 |ς|) (S70 (enter-scope-state-p64 |ς| (object-address "cstrncat::1::s") (_ bv8 64))))))

; find_symbols
(declare-fun S71 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S70 |ς|) (S71 (update-state-p64 |ς| (object-address "cstrncat::1::s") (evaluate-p64 |ς| (object-address "cstrncat::s1")))))))

; find_symbols
(declare-fun S75 (state) Bool)
; find_symbols
(declare-fun S72in (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S75 |ς|) (S72in |ς|))))

; set_to true
(assert (forall ((|ς| state)) (=> (S71 |ς|) (S72in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (and (S72 |ς|) (not (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrncat::1::s")))) (_ bv0 32))))) (S73T |ς|))))

; find_symbols
(declare-fun S73 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S72 |ς|) (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrncat::1::s")))) (_ bv0 32)))) (S73 |ς|))))

; find_symbols
(declare-fun S74 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S73 |ς|) (S74 (update-state-p64 |ς| (object-address "cstrncat::1::s") (bvadd (evaluate-p64 |ς| (object-address "cstrncat::1::s")) (_ bv1 64)))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S91 |ς|) (S77in |ς|))))

; set_to true
(assert (forall ((|ς| state)) (=> (S76 |ς|) (S77in |ς|))))

; find_symbols
(declare-fun S77T (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S77in |ς|) (not (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "cstrncat::n"))) (_ bv0 32))))) (S77T |ς|))))

; find_symbols
(declare-fun S77 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S77in |ς|) (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "cstrncat::n"))) (_ bv0 32)))) (S77 |ς|))))

; find_symbols
(declare-fun S78 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S77 |ς|) (S78 (enter-scope-state-p64 |ς| (object-address "cstrncat::$tmp::tmp_post_s2") (_ bv8 64))))))

; find_symbols
(declare-fun S79 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S78 |ς|) (S79 (update-state-p64 |ς| (object-address "cstrncat::$tmp::tmp_post_s2") (evaluate-p64 |ς| (object-address "cstrncat::s2")))))))

; find_symbols
(declare-fun S80 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S79 |ς|) (S80 (update-state-p64 |ς| (object-address "cstrncat::s2") (bvadd (evaluate-p64 |ς| (object-address "cstrncat::s2")) (_ bv1 64)))))))

; find_symbols
(declare-fun S81 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S80 |ς|) (S81 (enter-scope-state-p64 |ς| (object-address "cstrncat::$tmp::tmp_assign") (_ bv1 64))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S82 |ς|) (S83 (update-state-s8 |ς| (object-address "cstrncat::$tmp::tmp_assign") (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrncat::$tmp::tmp_post_s2"))))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S84 |ς|) (S85 (update-state-s8 |ς| (evaluate-p64 |ς| (object-address "cstrncat::1::s")) (evaluate-s8 |ς| (object-address "cstrncat::$tmp::tmp_assign")))))))

; find_symbols
(declare-fun S86T (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S85 |ς|) (not (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "cstrncat::$tmp::tmp_assign"))) (_ bv0 32))))) (S86T |ς|))))

; find_symbols
(declare-fun S86 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S85 |ς|) (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "cstrncat::$tmp::tmp_assign"))) (_ bv0 32)))) (S86 |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S88 |ς|) (S89 (update-state-s8 |ς| (object-address "cstrncat::n") (bvsub (evaluate-s8 |ς| (object-address "cstrncat::n")) (_ bv1 8)))))))

; find_symbols
(declare-fun S90 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S89 |ς|) (S90 (update-state-p64 |ς| (object-address "cstrncat::1::s") (bvadd (evaluate-p64 |ς| (object-address "cstrncat::1::s")) (_ bv1 64)))))))

; set_to true
(assert (= S91 S90))

; find_symbols
(declare-fun S92in (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S77T |ς|) (S92in |ς|))))

; set_to true
(assert (forall ((|ς| state)) (=> (S86T |ς|) (S92in |ς|))))
...
; find_symbols
(declare-fun S94T (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S93 |ς|) (not (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrncat::1::s")))) (_ bv0 32))))) (S94T |ς|))))

; find_symbols
(declare-fun S94 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S93 |ς|) (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrncat::1::s")))) (_ bv0 32)))) (S94 |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S95 |ς|) (S96 (update-state-s8 |ς| (evaluate-p64 |ς| (object-address "cstrncat::1::s")) ((_ extract 7 0) (_ bv0 32)))))))

; find_symbols
(declare-fun S97in (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S94T |ς|) (S97in |ς|))))

; set_to true
(assert (forall ((|ς| state)) (=> (S96 |ς|) (S97in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S98 |ς|) (S99 (exit-scope-state-p64 |ς| (object-address "cstrncat::$tmp::tmp_assign"))))))

; find_symbols
(declare-fun S100 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S99 |ς|) (S100 (exit-scope-state-p64 |ς| (object-address "cstrncat::$tmp::tmp_post_s2"))))))

; find_symbols
(declare-fun S101 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S100 |ς|) (S101 (exit-scope-state-p64 |ς| (object-address "cstrncat::1::s"))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S103 |ς|) (S104 (exit-scope-state-p64 |ς| (object-address "cstrncat::s1"))))))

; find_symbols
(declare-fun S105 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S104 |ς|) (S105 (exit-scope-state-p64 |ς| (object-address "cstrncat::s2"))))))

; find_symbols
(declare-fun S106 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S105 |ς|) (S106 (exit-scope-state-p64 |ς| (object-address "cstrncat::n"))))))

; find_symbols
(declare-fun S107 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S106 |ς|) (S107 (update-state-s8 |ς| (object-address "return'") ((_ extract 7 0) (_ bv0 32)))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S111 |ς|) (S112 (exit-scope-state-p64 |ς| (object-address "main::1::n"))))))

; find_symbols
(declare-fun S113 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S112 |ς|) (S113 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value___VERIFIER_nondet_char$1"))))))

; find_symbols
(declare-fun S114 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S113 |ς|) (S114 (exit-scope-state-p64 |ς| (object-address "main::1::length2"))))))

; find_symbols
(declare-fun S115 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S114 |ς|) (S115 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value___VERIFIER_nondet_char$0"))))))

; find_symbols
(declare-fun S116 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S115 |ς|) (S116 (exit-scope-state-p64 |ς| (object-address "main::1::length1"))))))

; find_symbols
(declare-fun S117 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S116 |ς|) (S117 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value___VERIFIER_nondet_char"))))))
...
; find_symbols
(declare-fun S119in (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S49 |ς|) (S119in |ς|))))

; set_to true
(assert (forall ((|ς| state)) (=> (S118 |ς|) (S119in |ς|))))
