...
; set_to true
(assert (forall ((|ς| state)) (=> (S44 |ς|) (S45 (enter-scope-state-p64 |ς| (object-address "expandArray::1::b") (_ bv8 64))))))

; find_symbols
(declare-fun S46 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S45 |ς|) (S46 (update-state-p64 |ς| (object-address "expandArray::1::b") ((_ sign_extend 32) (_ bv0 32)))))))

; find_symbols
(declare-fun S57 (state) Bool)
; find_symbols
(declare-fun S47in (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S57 |ς|) (S47in |ς|))))

; set_to true
(assert (forall ((|ς| state)) (=> (S46 |ς|) (S47in |ς|))))

; find_symbols
(declare-fun S47T (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S47in |ς|) (not (bvslt (evaluate-s32 |ς| (object-address "newsize")) (evaluate-s32 |ς| (object-address "num"))))) (S47T |ς|))))

; find_symbols
(declare-fun S47 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S47in |ς|) (bvslt (evaluate-s32 |ς| (object-address "newsize")) (evaluate-s32 |ς| (object-address "num")))) (S47 |ς|))))

; find_symbols
(declare-fun S48 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S47 |ς|) (S48 (update-state-s32 |ς| (object-address "newsize") (bvadd (evaluate-s32 |ς| (object-address "newsize")) (_ bv1 32)))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S51 |ς|) (S52 (update-state-p64 |ς| (object-address "expandArray::1::b") (evaluate-p64 |ς| (object-address "expandArray::$tmp::return_value_realloc")))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S53 |ς|) (S54 (update-state-s32 |ς| (bvadd (evaluate-p64 |ς| (object-address "expandArray::1::b")) (bvmul ((_ sign_extend 32) (bvsub (evaluate-s32 |ς| (object-address "newsize")) (_ bv1 32))) (_ bv4 64))) (evaluate-s32 |ς| (object-address "i")))))))

; find_symbols
(declare-fun S55 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S54 |ς|) (S55 (update-state-p64 |ς| (object-address "expandArray::1::a") (evaluate-p64 |ς| (object-address "expandArray::1::b")))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (and (S58 |ς|) (not (not (= (evaluate-p64 |ς| (object-address "expandArray::1::b")) (_ bv0 64))))) (S59T |ς|))))

; find_symbols
(declare-fun S59 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S58 |ς|) (not (= (evaluate-p64 |ς| (object-address "expandArray::1::b")) (_ bv0 64)))) (S59 |ς|))))
...
(assert (= S60 S59))
; __CPROVER__start → free

; find_symbols
(declare-fun S61 (state) Bool)
(declare-fun deallocate (state (_ BitVec 64)) state)
; set_to true
(assert (forall ((|ς| state)) (=> (S60 |ς|) (S61 (deallocate |ς| (evaluate-p64 |ς| (object-address "expandArray::1::b")))))))

; find_symbols
(declare-fun S62in (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S59T |ς|) (S62in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S63 |ς|) (S64 (exit-scope-state-p64 |ς| (object-address "expandArray::1::b"))))))

; find_symbols
(declare-fun S65 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S64 |ς|) (S65 (exit-scope-state-p64 |ς| (object-address "expandArray::1::a"))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S67 |ς|) (S68 (exit-scope-state-p64 |ς| (object-address "expandArray::arg"))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S69 |ς|) (S70 (deallocate |ς| (evaluate-p64 |ς| (object-address "main::1::a")))))))

; find_symbols
(declare-fun S71 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S70 |ς|) (S71 (update-state-s32 |ς| (object-address "return'") (_ bv0 32))))))

; find_symbols
(declare-fun S72 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S71 |ς|) (S72 (exit-scope-state-p64 |ς| (object-address "main::1::a"))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S27 |ς|) (S75in |ς|))))

; set_to true
(assert (forall ((|ς| state)) (=> (S37 |ς|) (S75in |ς|))))
