...
; set_to true
(assert (forall ((|ς| state)) (=> (S45 |ς|) (S46 (enter-scope-state-p64 |ς| (object-address "main::$tmp::return_value_cstrcspn") (_ bv1 64))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S51 |ς|) (S52 (enter-scope-state-p64 |ς| (object-address "cstrcspn::1::sc1") (_ bv8 64))))))

; find_symbols
(declare-fun S53 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S52 |ς|) (S53 (enter-scope-state-p64 |ς| (object-address "cstrcspn::1::s") (_ bv8 64))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S54 |ς|) (S55 (update-state-p64 |ς| (object-address "cstrcspn::1::sc1") (evaluate-p64 |ς| (object-address "cstrcspn::s1")))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (and (S56 |ς|) (not (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrcspn::1::sc1")))) (_ bv0 32))))) (S57T |ς|))))

; find_symbols
(declare-fun S57 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S56 |ς|) (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrcspn::1::sc1")))) (_ bv0 32)))) (S57 |ς|))))

; find_symbols
(declare-fun S58 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S57 |ς|) (S58 (update-state-p64 |ς| (object-address "cstrcspn::1::s") (evaluate-p64 |ς| (object-address "cstrcspn::s2")))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S59 |ς|) (S60 (update-state-s8 |ς| (object-address "cstrcspn::1::c") (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrcspn::1::sc1"))))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (and (S61 |ς|) (not (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrcspn::1::s")))) (_ bv0 32))))) (S62T |ς|))))

; find_symbols
(declare-fun S62 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S61 |ς|) (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrcspn::1::s")))) (_ bv0 32)))) (S62 |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (and (S63 |ς|) (not (not (= (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrcspn::1::s"))) (evaluate-s8 |ς| (object-address "cstrcspn::1::c")))))) (S64T |ς|))))

; find_symbols
(declare-fun S64 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S63 |ς|) (not (= (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrcspn::1::s"))) (evaluate-s8 |ς| (object-address "cstrcspn::1::c"))))) (S64 |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S66 |ς|) (S67 (update-state-p64 |ς| (object-address "cstrcspn::1::s") (bvadd (evaluate-p64 |ς| (object-address "cstrcspn::1::s")) (_ bv1 64)))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (and (S70 |ς|) (not (= (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrcspn::1::s"))) (evaluate-s8 |ς| (object-address "cstrcspn::1::c"))))) (S71T |ς|))))

; find_symbols
(declare-fun S71 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S70 |ς|) (= (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrcspn::1::s"))) (evaluate-s8 |ς| (object-address "cstrcspn::1::c")))) (S71 |ς|))))

; find_symbols
(declare-fun S72 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S71 |ς|) (S72 (update-state-s8 |ς| (object-address "main::$tmp::return_value_cstrcspn") ((_ extract 7 0) (bvsub (evaluate-p64 |ς| (object-address "cstrcspn::1::sc1")) (evaluate-p64 |ς| (object-address "cstrcspn::s1")))))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S73 |ς|) (S74 (exit-scope-state-p64 |ς| (object-address "cstrcspn::1::s"))))))

; find_symbols
(declare-fun S75 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S74 |ς|) (S75 (exit-scope-state-p64 |ς| (object-address "cstrcspn::1::sc1"))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S77 |ς|) (S78 (update-state-p64 |ς| (object-address "cstrcspn::1::sc1") (bvadd (evaluate-p64 |ς| (object-address "cstrcspn::1::sc1")) (_ bv1 64)))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S80 |ς|) (S81 (update-state-s8 |ς| (object-address "main::$tmp::return_value_cstrcspn") ((_ extract 7 0) (bvsub (evaluate-p64 |ς| (object-address "cstrcspn::1::sc1")) (evaluate-p64 |ς| (object-address "cstrcspn::s1")))))))))

; find_symbols
(declare-fun S82 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S81 |ς|) (S82 (exit-scope-state-p64 |ς| (object-address "cstrcspn::1::c"))))))

; find_symbols
(declare-fun S83 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S82 |ς|) (S83 (exit-scope-state-p64 |ς| (object-address "cstrcspn::1::s"))))))

; find_symbols
(declare-fun S84 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S83 |ς|) (S84 (exit-scope-state-p64 |ς| (object-address "cstrcspn::1::sc1"))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S86 |ς|) (S87 (exit-scope-state-p64 |ς| (object-address "cstrcspn::s1"))))))

; find_symbols
(declare-fun S88 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S87 |ς|) (S88 (exit-scope-state-p64 |ς| (object-address "cstrcspn::s2"))))))

; find_symbols
(declare-fun S89 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S88 |ς|) (S89 (update-state-s8 |ς| (object-address "return'") (evaluate-s8 |ς| (object-address "main::$tmp::return_value_cstrcspn")))))))

; find_symbols
(declare-fun S90 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S89 |ς|) (S90 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value_cstrcspn"))))))
