...
; set_to true
(assert (forall ((|ς| state)) (=> (S37 |ς|) (S38 (update-state-s8 |ς| (object-address "test_fun::1::i") ((_ extract 7 0) (_ bv0 32)))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S62 |ς|) (S39in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (and (S39in |ς|) (not (bvslt ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "test_fun::1::i"))) ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "test_fun::N")))))) (S39T |ς|))))

; find_symbols
(declare-fun S39 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S39in |ς|) (bvslt ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "test_fun::1::i"))) ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "test_fun::N"))))) (S39 |ς|))))

; find_symbols
(declare-fun S40 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S39 |ς|) (S40 (update-state-s8 |ς| (object-address "test_fun::1::res") ((_ extract 7 0) (_ bv1 32)))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (and (S41 |ς|) (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (bvadd (evaluate-p64 |ς| (object-address "test_fun::a")) ((_ sign_extend 56) (evaluate-s8 |ς| (object-address "test_fun::1::i")))))) (_ bv0 32)))) (S42T |ς|))))

; find_symbols
(declare-fun S42 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S41 |ς|) (= ((_ sign_extend 24) (evaluate-s8 |ς| (bvadd (evaluate-p64 |ς| (object-address "test_fun::a")) ((_ sign_extend 56) (evaluate-s8 |ς| (object-address "test_fun::1::i")))))) (_ bv0 32))) (S42 |ς|))))

; find_symbols
(declare-fun S43 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S42 |ς|) (S43 (update-state-s8 |ς| (object-address "test_fun::1::res") ((_ extract 7 0) (_ bv1 32)))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (and (S45 |ς|) (not (bvslt ((_ sign_extend 24) (evaluate-s8 |ς| (bvadd (evaluate-p64 |ς| (object-address "test_fun::a")) ((_ sign_extend 56) (evaluate-s8 |ς| (object-address "test_fun::1::i")))))) (_ bv0 32)))) (S46T |ς|))))

; find_symbols
(declare-fun S46 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S45 |ς|) (bvslt ((_ sign_extend 24) (evaluate-s8 |ς| (bvadd (evaluate-p64 |ς| (object-address "test_fun::a")) ((_ sign_extend 56) (evaluate-s8 |ς| (object-address "test_fun::1::i")))))) (_ bv0 32))) (S46 |ς|))))

; find_symbols
(declare-fun S47 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S46 |ς|) (S47 (update-state-s8 |ς| (object-address "test_fun::1::res") ((_ extract 7 0) (_ bv0 32)))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S44 |ς|) (S49in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S57 |ς|) (S50in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (and (S50 |ς|) (not (bvsgt ((_ sign_extend 24) (evaluate-s8 |ς| (bvadd (evaluate-p64 |ς| (object-address "test_fun::a")) ((_ sign_extend 56) (evaluate-s8 |ς| (object-address "test_fun::1::i")))))) (_ bv0 32)))) (S51T |ς|))))

; find_symbols
(declare-fun S51 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S50 |ς|) (bvsgt ((_ sign_extend 24) (evaluate-s8 |ς| (bvadd (evaluate-p64 |ς| (object-address "test_fun::a")) ((_ sign_extend 56) (evaluate-s8 |ς| (object-address "test_fun::1::i")))))) (_ bv0 32))) (S51 |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S52 |ς|) (S53 (update-state-s8 |ς| (object-address "test_fun::1::res") ((_ extract 7 0) (bvmul ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "test_fun::1::res"))) ((_ sign_extend 24) (evaluate-s8 |ς| (bvadd (evaluate-p64 |ς| (object-address "test_fun::a")) ((_ sign_extend 56) (evaluate-s8 |ς| (object-address "test_fun::1::i")))))))))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S55 |ς|) (S56 (update-state-s8 |ς| (bvadd (evaluate-p64 |ς| (object-address "test_fun::a")) ((_ sign_extend 56) (evaluate-s8 |ς| (object-address "test_fun::1::i")))) (bvsub (evaluate-s8 |ς| (bvadd (evaluate-p64 |ς| (object-address "test_fun::a")) ((_ sign_extend 56) (evaluate-s8 |ς| (object-address "test_fun::1::i"))))) (_ bv1 8)))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S59 |ς|) (S60 (update-state-s8 |ς| (bvadd (evaluate-p64 |ς| (object-address "test_fun::a")) ((_ sign_extend 56) (evaluate-s8 |ς| (object-address "test_fun::1::i")))) (evaluate-s8 |ς| (object-address "test_fun::1::res")))))))

; find_symbols
(declare-fun S61 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S60 |ς|) (S61 (update-state-s8 |ς| (object-address "test_fun::1::i") (bvadd (evaluate-s8 |ς| (object-address "test_fun::1::i")) (_ bv1 8)))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S63 |ς|) (S64 (exit-scope-state-p64 |ς| (object-address "test_fun::1::res"))))))

; find_symbols
(declare-fun S65 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S64 |ς|) (S65 (exit-scope-state-p64 |ς| (object-address "test_fun::1::i"))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S66 |ς|) (S67 (exit-scope-state-p64 |ς| (object-address "test_fun::a"))))))

; find_symbols
(declare-fun S68 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S67 |ς|) (S68 (exit-scope-state-p64 |ς| (object-address "test_fun::N"))))))

; find_symbols
(declare-fun S69 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S68 |ς|) (S69 (exit-scope-state-p64 |ς| (object-address "main::1::numbers"))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S70 |ς|) (S71 (exit-scope-state-p64 |ς| (object-address "main::1::array_size"))))))
...
; set_to true
(assert (forall ((|ς| state) (|nondet::S73-0| (_ BitVec 8))) (=> (S72 |ς|) (S73 (update-state-s8 |ς| (object-address "return'") |nondet::S73-0|)))))
