...
; set_to true
(assert (forall ((|ς| state)) (=> (S46 |ς|) (S47 (enter-scope-state-p64 |ς| (object-address "cstrpbrk::s1") (_ bv8 64))))))

; find_symbols
(declare-fun S48 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S47 |ς|) (S48 (update-state-p64 |ς| (object-address "cstrpbrk::s1") (evaluate-p64 |ς| (object-address "main::1::nondetString1")))))))

; find_symbols
(declare-fun S49 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S48 |ς|) (S49 (enter-scope-state-p64 |ς| (object-address "cstrpbrk::s2") (_ bv8 64))))))

; find_symbols
(declare-fun S50 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S49 |ς|) (S50 (update-state-p64 |ς| (object-address "cstrpbrk::s2") (evaluate-p64 |ς| (object-address "main::1::nondetString2")))))))

; find_symbols
(declare-fun S51 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S50 |ς|) (S51 (enter-scope-state-p64 |ς| (object-address "cstrpbrk::1::scanp") (_ bv8 64))))))

; find_symbols
(declare-fun S52 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S51 |ς|) (S52 (enter-scope-state-p64 |ς| (object-address "cstrpbrk::1::c") (_ bv1 64))))))

; find_symbols
(declare-fun S53 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S52 |ς|) (S53 (enter-scope-state-p64 |ς| (object-address "cstrpbrk::1::sc") (_ bv1 64))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S80 |ς|) (S54in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S54in |ς|) (S54 (enter-scope-state-p64 |ς| (object-address "cstrpbrk::$tmp::tmp_post_s1") (_ bv8 64))))))

; find_symbols
(declare-fun S55 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S54 |ς|) (S55 (update-state-p64 |ς| (object-address "cstrpbrk::$tmp::tmp_post_s1") (evaluate-p64 |ς| (object-address "cstrpbrk::s1")))))))

; find_symbols
(declare-fun S56 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S55 |ς|) (S56 (update-state-p64 |ς| (object-address "cstrpbrk::s1") (bvadd (evaluate-p64 |ς| (object-address "cstrpbrk::s1")) (_ bv1 64)))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S57 |ς|) (S58 (update-state-s8 |ς| (object-address "cstrpbrk::1::c") (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrpbrk::$tmp::tmp_post_s1"))))))))

; find_symbols
(declare-fun S59T (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S58 |ς|) (not (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "cstrpbrk::1::c"))) (_ bv0 32))))) (S59T |ς|))))

; find_symbols
(declare-fun S59 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S58 |ς|) (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "cstrpbrk::1::c"))) (_ bv0 32)))) (S59 |ς|))))

; find_symbols
(declare-fun S60 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S59 |ς|) (S60 (update-state-p64 |ς| (object-address "cstrpbrk::1::scanp") (evaluate-p64 |ς| (object-address "cstrpbrk::s2")))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S77 |ς|) (S61in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S61in |ς|) (S61 (enter-scope-state-p64 |ς| (object-address "cstrpbrk::$tmp::tmp_post_scanp") (_ bv8 64))))))

; find_symbols
(declare-fun S62 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S61 |ς|) (S62 (update-state-p64 |ς| (object-address "cstrpbrk::$tmp::tmp_post_scanp") (evaluate-p64 |ς| (object-address "cstrpbrk::1::scanp")))))))

; find_symbols
(declare-fun S63 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S62 |ς|) (S63 (update-state-p64 |ς| (object-address "cstrpbrk::1::scanp") (bvadd (evaluate-p64 |ς| (object-address "cstrpbrk::1::scanp")) (_ bv1 64)))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S64 |ς|) (S65 (update-state-s8 |ς| (object-address "cstrpbrk::1::sc") (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrpbrk::$tmp::tmp_post_scanp"))))))))

; find_symbols
(declare-fun S66T (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S65 |ς|) (not (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "cstrpbrk::1::sc"))) (_ bv0 32))))) (S66T |ς|))))

; find_symbols
(declare-fun S66 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S65 |ς|) (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "cstrpbrk::1::sc"))) (_ bv0 32)))) (S66 |ς|))))

; find_symbols
(declare-fun S67T (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S66 |ς|) (not (= (evaluate-s8 |ς| (object-address "cstrpbrk::1::sc")) (evaluate-s8 |ς| (object-address "cstrpbrk::1::c"))))) (S67T |ς|))))

; find_symbols
(declare-fun S67 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S66 |ς|) (= (evaluate-s8 |ς| (object-address "cstrpbrk::1::sc")) (evaluate-s8 |ς| (object-address "cstrpbrk::1::c")))) (S67 |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S68 |ς|) (S69 (exit-scope-state-p64 |ς| (object-address "cstrpbrk::$tmp::tmp_post_scanp"))))))

; find_symbols
(declare-fun S70 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S69 |ς|) (S70 (exit-scope-state-p64 |ς| (object-address "cstrpbrk::$tmp::tmp_post_s1"))))))

; find_symbols
(declare-fun S71 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S70 |ς|) (S71 (exit-scope-state-p64 |ς| (object-address "cstrpbrk::1::sc"))))))

; find_symbols
(declare-fun S72 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S71 |ς|) (S72 (exit-scope-state-p64 |ς| (object-address "cstrpbrk::1::c"))))))

; find_symbols
(declare-fun S73 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S72 |ς|) (S73 (exit-scope-state-p64 |ς| (object-address "cstrpbrk::1::scanp"))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S78 |ς|) (S79 (exit-scope-state-p64 |ς| (object-address "cstrpbrk::$tmp::tmp_post_scanp"))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S82 |ς|) (S83 (exit-scope-state-p64 |ς| (object-address "cstrpbrk::$tmp::tmp_post_s1"))))))

; find_symbols
(declare-fun S84 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S83 |ς|) (S84 (exit-scope-state-p64 |ς| (object-address "cstrpbrk::1::sc"))))))

; find_symbols
(declare-fun S85 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S84 |ς|) (S85 (exit-scope-state-p64 |ς| (object-address "cstrpbrk::1::c"))))))

; find_symbols
(declare-fun S86 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S85 |ς|) (S86 (exit-scope-state-p64 |ς| (object-address "cstrpbrk::1::scanp"))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S74 |ς|) (S88in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S88 |ς|) (S89 (exit-scope-state-p64 |ς| (object-address "cstrpbrk::s1"))))))

; find_symbols
(declare-fun S90 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S89 |ς|) (S90 (exit-scope-state-p64 |ς| (object-address "cstrpbrk::s2"))))))

; find_symbols
(declare-fun S91 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S90 |ς|) (S91 (update-state-s8 |ς| (object-address "return'") ((_ extract 7 0) (_ bv0 32)))))))
