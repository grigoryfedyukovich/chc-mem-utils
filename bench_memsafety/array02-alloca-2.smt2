...
; set_to true
(assert (forall ((|ς| state)) (=> (S36 |ς|) (S37 (enter-scope-state-p64 |ς| (object-address "test_fun::1::pos") (_ bv1 64))))))

; find_symbols
(declare-fun S38 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S37 |ς|) (S38 (update-state-s8 |ς| (object-address "test_fun::1::pos") ((_ extract 7 0) (_ bv0 32)))))))

; find_symbols
(declare-fun S39 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S38 |ς|) (S39 (enter-scope-state-p64 |ς| (object-address "test_fun::1::neg") (_ bv1 64))))))

; find_symbols
(declare-fun S40 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S39 |ς|) (S40 (update-state-s8 |ς| (object-address "test_fun::1::neg") ((_ extract 7 0) (_ bv0 32)))))))

; find_symbols
(declare-fun S41 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S40 |ς|) (S41 (update-state-s8 |ς| (object-address "test_fun::1::i") ((_ extract 7 0) (_ bv0 32)))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S60 |ς|) (S42in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (and (S42in |ς|) (not (bvslt ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "test_fun::1::i"))) ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "test_fun::N")))))) (S42T |ς|))))

; find_symbols
(declare-fun S42 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S42in |ς|) (bvslt ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "test_fun::1::i"))) ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "test_fun::N"))))) (S42 |ς|))))

; find_symbols
(declare-fun S49 (state) Bool)
; find_symbols
(declare-fun S43in (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S49 |ς|) (S43in |ς|))))

; set_to true
(assert (forall ((|ς| state)) (=> (S42 |ς|) (S43in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (and (S43 |ς|) (not (bvslt ((_ sign_extend 24) (evaluate-s8 |ς| (bvadd (evaluate-p64 |ς| (object-address "test_fun::a")) ((_ sign_extend 56) (evaluate-s8 |ς| (object-address "test_fun::1::i")))))) (_ bv0 32)))) (S44T |ς|))))

; find_symbols
(declare-fun S44 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S43 |ς|) (bvslt ((_ sign_extend 24) (evaluate-s8 |ς| (bvadd (evaluate-p64 |ς| (object-address "test_fun::a")) ((_ sign_extend 56) (evaluate-s8 |ς| (object-address "test_fun::1::i")))))) (_ bv0 32))) (S44 |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S46 |ς|) (S47 (update-state-s8 |ς| (bvadd (evaluate-p64 |ς| (object-address "test_fun::a")) ((_ sign_extend 56) (evaluate-s8 |ς| (object-address "test_fun::1::i")))) (bvadd (evaluate-s8 |ς| (bvadd (evaluate-p64 |ς| (object-address "test_fun::a")) ((_ sign_extend 56) (evaluate-s8 |ς| (object-address "test_fun::1::i"))))) (_ bv1 8)))))))

; find_symbols
(declare-fun S48 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S47 |ς|) (S48 (update-state-s8 |ς| (object-address "test_fun::1::neg") (bvadd (evaluate-s8 |ς| (object-address "test_fun::1::neg")) (_ bv1 8)))))))
...
; find_symbols
(declare-fun S51in (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S57 |ς|) (S51in |ς|))))

; set_to true
(assert (forall ((|ς| state)) (=> (S50 |ς|) (S51in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (and (S51 |ς|) (not (bvsgt ((_ sign_extend 24) (evaluate-s8 |ς| (bvadd (evaluate-p64 |ς| (object-address "test_fun::a")) ((_ sign_extend 56) (evaluate-s8 |ς| (object-address "test_fun::1::i")))))) (_ bv0 32)))) (S52T |ς|))))

; find_symbols
(declare-fun S52 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S51 |ς|) (bvsgt ((_ sign_extend 24) (evaluate-s8 |ς| (bvadd (evaluate-p64 |ς| (object-address "test_fun::a")) ((_ sign_extend 56) (evaluate-s8 |ς| (object-address "test_fun::1::i")))))) (_ bv0 32))) (S52 |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S54 |ς|) (S55 (update-state-s8 |ς| (bvadd (evaluate-p64 |ς| (object-address "test_fun::a")) ((_ sign_extend 56) (evaluate-s8 |ς| (object-address "test_fun::1::i")))) (bvsub (evaluate-s8 |ς| (bvadd (evaluate-p64 |ς| (object-address "test_fun::a")) ((_ sign_extend 56) (evaluate-s8 |ς| (object-address "test_fun::1::i"))))) (_ bv1 8)))))))

; find_symbols
(declare-fun S56 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S55 |ς|) (S56 (update-state-s8 |ς| (object-address "test_fun::1::pos") (bvadd (evaluate-s8 |ς| (object-address "test_fun::1::pos")) (_ bv1 8)))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S58 |ς|) (S59 (update-state-s8 |ς| (object-address "test_fun::1::i") (bvadd (evaluate-s8 |ς| (object-address "test_fun::1::i")) (_ bv1 8)))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S61 |ς|) (S62 (exit-scope-state-p64 |ς| (object-address "test_fun::1::neg"))))))

; find_symbols
(declare-fun S63 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S62 |ς|) (S63 (exit-scope-state-p64 |ς| (object-address "test_fun::1::pos"))))))

; find_symbols
(declare-fun S64 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S63 |ς|) (S64 (exit-scope-state-p64 |ς| (object-address "test_fun::1::i"))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S65 |ς|) (S66 (exit-scope-state-p64 |ς| (object-address "test_fun::a"))))))

; find_symbols
(declare-fun S67 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S66 |ς|) (S67 (exit-scope-state-p64 |ς| (object-address "test_fun::N"))))))

; find_symbols
(declare-fun S68 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S67 |ς|) (S68 (exit-scope-state-p64 |ς| (object-address "main::1::numbers"))))))

; find_symbols
(declare-fun S69 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S68 |ς|) (S69 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value_malloc"))))))

; find_symbols
(declare-fun S70 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S69 |ς|) (S70 (exit-scope-state-p64 |ς| (object-address "main::1::array_size"))))))

; find_symbols
(declare-fun S71 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S70 |ς|) (S71 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value___VERIFIER_nondet_char"))))))

; find_symbols
(declare-fun S72 (state) Bool)
; set_to true
(assert (forall ((|ς| state) (|nondet::S72-0| (_ BitVec 8))) (=> (S71 |ς|) (S72 (update-state-s8 |ς| (object-address "return'") |nondet::S72-0|)))))
