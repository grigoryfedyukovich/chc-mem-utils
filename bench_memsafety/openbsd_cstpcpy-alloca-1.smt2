...
; set_to true
(assert (forall ((|ς| state)) (=> (S52 |ς|) (S53 (enter-scope-state-p64 |ς| (object-address "cstpcpy::to") (_ bv8 64))))))

; find_symbols
(declare-fun S54 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S53 |ς|) (S54 (update-state-p64 |ς| (object-address "cstpcpy::to") (evaluate-p64 |ς| (object-address "main::1::nondetArea")))))))

; find_symbols
(declare-fun S55 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S54 |ς|) (S55 (enter-scope-state-p64 |ς| (object-address "cstpcpy::from") (_ bv8 64))))))

; find_symbols
(declare-fun S56 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S55 |ς|) (S56 (update-state-p64 |ς| (object-address "cstpcpy::from") (evaluate-p64 |ς| (object-address "main::1::nondetString")))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S67 |ς|) (S58in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S58in |ς|) (S58 (enter-scope-state-p64 |ς| (object-address "cstpcpy::$tmp::tmp_assign") (_ bv1 64))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S59 |ς|) (S60 (update-state-s8 |ς| (object-address "cstpcpy::$tmp::tmp_assign") (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstpcpy::from"))))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S61 |ς|) (S62 (update-state-s8 |ς| (evaluate-p64 |ς| (object-address "cstpcpy::to")) (evaluate-s8 |ς| (object-address "cstpcpy::$tmp::tmp_assign")))))))

; find_symbols
(declare-fun S63T (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S62 |ς|) (not (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "cstpcpy::$tmp::tmp_assign"))) (_ bv0 32))))) (S63T |ς|))))

; find_symbols
(declare-fun S63 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S62 |ς|) (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "cstpcpy::$tmp::tmp_assign"))) (_ bv0 32)))) (S63 |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S64 |ς|) (S65 (update-state-p64 |ς| (object-address "cstpcpy::from") (bvadd (evaluate-p64 |ς| (object-address "cstpcpy::from")) (_ bv1 64)))))))

; find_symbols
(declare-fun S66 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S65 |ς|) (S66 (update-state-p64 |ς| (object-address "cstpcpy::to") (bvadd (evaluate-p64 |ς| (object-address "cstpcpy::to")) (_ bv1 64)))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S68 |ς|) (S69 (exit-scope-state-p64 |ς| (object-address "cstpcpy::$tmp::tmp_assign"))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S72 |ς|) (S73 (exit-scope-state-p64 |ς| (object-address "cstpcpy::to"))))))

; find_symbols
(declare-fun S74 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S73 |ς|) (S74 (exit-scope-state-p64 |ς| (object-address "cstpcpy::from"))))))

; find_symbols
(declare-fun S75 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S74 |ς|) (S75 (update-state-s8 |ς| (object-address "return'") ((_ extract 7 0) (_ bv0 32)))))))

; find_symbols
(declare-fun S76 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S75 |ς|) (S76 (exit-scope-state-p64 |ς| (object-address "main::1::nondetString"))))))

; find_symbols
(declare-fun S77 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S76 |ς|) (S77 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value_malloc$0"))))))

; find_symbols
(declare-fun S78 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S77 |ς|) (S78 (exit-scope-state-p64 |ς| (object-address "main::1::nondetArea"))))))

; find_symbols
(declare-fun S79 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S78 |ς|) (S79 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value_malloc"))))))

; find_symbols
(declare-fun S80 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S79 |ς|) (S80 (exit-scope-state-p64 |ς| (object-address "main::1::length2"))))))

; find_symbols
(declare-fun S81 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S80 |ς|) (S81 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value___VERIFIER_nondet_char$0"))))))

; find_symbols
(declare-fun S82 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S81 |ς|) (S82 (exit-scope-state-p64 |ς| (object-address "main::1::length1"))))))

; find_symbols
(declare-fun S83 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S82 |ς|) (S83 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value___VERIFIER_nondet_char"))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S40 |ς|) (S85in |ς|))))
