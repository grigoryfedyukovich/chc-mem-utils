...
; set_to true
(assert (forall ((|ς| state)) (=> (S50 |ς|) (S51 (enter-scope-state-p64 |ς| (object-address "cstrpbrk::1::sc1") (_ bv8 64))))))

; find_symbols
(declare-fun S52 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S51 |ς|) (S52 (enter-scope-state-p64 |ς| (object-address "cstrpbrk::1::s") (_ bv8 64))))))

; find_symbols
(declare-fun S53 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S52 |ς|) (S53 (enter-scope-state-p64 |ς| (object-address "cstrpbrk::1::c") (_ bv1 64))))))

; find_symbols
(declare-fun S54 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S53 |ς|) (S54 (update-state-p64 |ς| (object-address "cstrpbrk::1::sc1") (evaluate-p64 |ς| (object-address "cstrpbrk::s1")))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S78 |ς|) (S55in |ς|))))

; set_to true
(assert (forall ((|ς| state)) (=> (S54 |ς|) (S55in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (and (S55 |ς|) (not (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrpbrk::1::sc1")))) (_ bv0 32))))) (S56T |ς|))))

; find_symbols
(declare-fun S56 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S55 |ς|) (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrpbrk::1::sc1")))) (_ bv0 32)))) (S56 |ς|))))

; find_symbols
(declare-fun S57 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S56 |ς|) (S57 (update-state-p64 |ς| (object-address "cstrpbrk::1::s") (evaluate-p64 |ς| (object-address "cstrpbrk::s2")))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S58 |ς|) (S59 (update-state-s8 |ς| (object-address "cstrpbrk::1::c") (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrpbrk::1::sc1"))))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S67 |ς|) (S60in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (and (S60 |ς|) (not (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrpbrk::1::s")))) (_ bv0 32))))) (S61T |ς|))))

; find_symbols
(declare-fun S61 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S60 |ς|) (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrpbrk::1::s")))) (_ bv0 32)))) (S61 |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (and (S62 |ς|) (not (not (= (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrpbrk::1::s"))) (evaluate-s8 |ς| (object-address "cstrpbrk::1::c")))))) (S63T |ς|))))

; find_symbols
(declare-fun S63 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S62 |ς|) (not (= (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrpbrk::1::s"))) (evaluate-s8 |ς| (object-address "cstrpbrk::1::c"))))) (S63 |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S65 |ς|) (S66 (update-state-p64 |ς| (object-address "cstrpbrk::1::s") (bvadd (evaluate-p64 |ς| (object-address "cstrpbrk::1::s")) (_ bv1 64)))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S61T |ς|) (S68in |ς|))))

; set_to true
(assert (forall ((|ς| state)) (=> (S63T |ς|) (S68in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (and (S69 |ς|) (not (not (= (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrpbrk::1::s"))) (evaluate-s8 |ς| (object-address "cstrpbrk::1::c")))))) (S70T |ς|))))

; find_symbols
(declare-fun S70 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S69 |ς|) (not (= (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrpbrk::1::s"))) (evaluate-s8 |ς| (object-address "cstrpbrk::1::c"))))) (S70 |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S72 |ς|) (S73 (exit-scope-state-p64 |ς| (object-address "cstrpbrk::1::s"))))))

; find_symbols
(declare-fun S74 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S73 |ς|) (S74 (exit-scope-state-p64 |ς| (object-address "cstrpbrk::1::sc1"))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S76 |ς|) (S77 (update-state-p64 |ς| (object-address "cstrpbrk::1::sc1") (bvadd (evaluate-p64 |ς| (object-address "cstrpbrk::1::sc1")) (_ bv1 64)))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S80 |ς|) (S81 (exit-scope-state-p64 |ς| (object-address "cstrpbrk::1::c"))))))

; find_symbols
(declare-fun S82 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S81 |ς|) (S82 (exit-scope-state-p64 |ς| (object-address "cstrpbrk::1::s"))))))

; find_symbols
(declare-fun S83 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S82 |ς|) (S83 (exit-scope-state-p64 |ς| (object-address "cstrpbrk::1::sc1"))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S85 |ς|) (S86 (exit-scope-state-p64 |ς| (object-address "cstrpbrk::s1"))))))

; find_symbols
(declare-fun S87 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S86 |ς|) (S87 (exit-scope-state-p64 |ς| (object-address "cstrpbrk::s2"))))))

; find_symbols
(declare-fun S88 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S87 |ς|) (S88 (update-state-s8 |ς| (object-address "return'") ((_ extract 7 0) (_ bv0 32)))))))

; find_symbols
(declare-fun S89 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S88 |ς|) (S89 (exit-scope-state-p64 |ς| (object-address "main::1::nondetString2"))))))

; find_symbols
(declare-fun S90 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S89 |ς|) (S90 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value_malloc$0"))))))

; find_symbols
(declare-fun S91 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S90 |ς|) (S91 (exit-scope-state-p64 |ς| (object-address "main::1::nondetString1"))))))

; find_symbols
(declare-fun S92 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S91 |ς|) (S92 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value_malloc"))))))

; find_symbols
(declare-fun S93 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S92 |ς|) (S93 (exit-scope-state-p64 |ς| (object-address "main::1::length2"))))))

; find_symbols
(declare-fun S94 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S93 |ς|) (S94 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value___VERIFIER_nondet_char$0"))))))

; find_symbols
(declare-fun S95 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S94 |ς|) (S95 (exit-scope-state-p64 |ς| (object-address "main::1::length1"))))))

; find_symbols
(declare-fun S96 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S95 |ς|) (S96 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value___VERIFIER_nondet_char"))))))
