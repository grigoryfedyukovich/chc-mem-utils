...
; set_to true
(assert (forall ((|ς| state)) (=> (S45 |ς|) (S46 (enter-scope-state-p64 |ς| (object-address "main::$tmp::return_value_subseq") (_ bv1 64))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S47 |ς|) (S48 (enter-scope-state-p64 |ς| (object-address "subseq::s") (_ bv8 64))))))

; find_symbols
(declare-fun S49 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S48 |ς|) (S49 (update-state-p64 |ς| (object-address "subseq::s") (evaluate-p64 |ς| (object-address "main::1::nondetString1")))))))

; find_symbols
(declare-fun S50 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S49 |ς|) (S50 (enter-scope-state-p64 |ς| (object-address "subseq::t") (_ bv8 64))))))

; find_symbols
(declare-fun S51 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S50 |ς|) (S51 (update-state-p64 |ς| (object-address "subseq::t") (evaluate-p64 |ς| (object-address "main::1::nondetString2")))))))

; find_symbols
(declare-fun S52 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S51 |ς|) (S52 (enter-scope-state-p64 |ς| (object-address "subseq::1::ps") (_ bv8 64))))))

; find_symbols
(declare-fun S53 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S52 |ς|) (S53 (update-state-p64 |ς| (object-address "subseq::1::ps") (evaluate-p64 |ς| (object-address "subseq::s")))))))

; find_symbols
(declare-fun S54 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S53 |ς|) (S54 (enter-scope-state-p64 |ς| (object-address "subseq::1::pt") (_ bv8 64))))))

; find_symbols
(declare-fun S55 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S54 |ς|) (S55 (update-state-p64 |ς| (object-address "subseq::1::pt") (evaluate-p64 |ς| (object-address "subseq::t")))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S68 |ς|) (S56in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (and (S56 |ς|) (not (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "subseq::1::ps")))) (_ bv0 32))))) (S57T |ς|))))

; find_symbols
(declare-fun S57 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S56 |ς|) (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "subseq::1::ps")))) (_ bv0 32)))) (S57 |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (and (S58 |ς|) (not (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "subseq::1::pt")))) (_ bv0 32))))) (S59T |ς|))))

; find_symbols
(declare-fun S59 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S58 |ς|) (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "subseq::1::pt")))) (_ bv0 32)))) (S59 |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (and (S63 |ς|) (not (= (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "subseq::1::ps"))) (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "subseq::1::pt")))))) (S64T |ς|))))

; find_symbols
(declare-fun S64 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S63 |ς|) (= (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "subseq::1::ps"))) (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "subseq::1::pt"))))) (S64 |ς|))))

; find_symbols
(declare-fun S65 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S64 |ς|) (S65 (update-state-p64 |ς| (object-address "subseq::1::ps") (bvadd (evaluate-p64 |ς| (object-address "subseq::1::ps")) (_ bv1 64)))))))

; find_symbols
(declare-fun S66in (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S64T |ς|) (S66in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S66 |ς|) (S67 (update-state-p64 |ς| (object-address "subseq::1::pt") (bvadd (evaluate-p64 |ς| (object-address "subseq::1::pt")) (_ bv1 64)))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S57T |ς|) (S69in |ς|))))

; set_to true
(assert (forall ((|ς| state)) (=> (S59T |ς|) (S69in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (and (S70 |ς|) (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "subseq::1::pt")))) (_ bv0 32)))) (S71T |ς|))))

; find_symbols
(declare-fun S71 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S70 |ς|) (= ((_ sign_extend 24) (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "subseq::1::pt")))) (_ bv0 32))) (S71 |ς|))))

; find_symbols
(declare-fun S72 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S71 |ς|) (S72 (update-state-s8 |ς| (object-address "main::$tmp::return_value_subseq") ((_ extract 7 0) (_ bv1 32)))))))

; find_symbols
(declare-fun S73 (state) Bool)
(declare-fun exit-scope-state-p64 (state (_ BitVec 64)) state)
; set_to true
(assert (forall ((|ς| state)) (=> (S72 |ς|) (S73 (exit-scope-state-p64 |ς| (object-address "subseq::1::pt"))))))

; find_symbols
(declare-fun S74 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S73 |ς|) (S74 (exit-scope-state-p64 |ς| (object-address "subseq::1::ps"))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S71T |ς|) (S77 (update-state-s8 |ς| (object-address "main::$tmp::return_value_subseq") ((_ extract 7 0) (_ bv0 32)))))))

; find_symbols
(declare-fun S78 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S77 |ς|) (S78 (exit-scope-state-p64 |ς| (object-address "subseq::1::pt"))))))

; find_symbols
(declare-fun S79 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S78 |ς|) (S79 (exit-scope-state-p64 |ς| (object-address "subseq::1::ps"))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S81 |ς|) (S82 (exit-scope-state-p64 |ς| (object-address "subseq::1::pt"))))))

; find_symbols
(declare-fun S83 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S82 |ς|) (S83 (exit-scope-state-p64 |ς| (object-address "subseq::1::ps"))))))

; find_symbols
(declare-fun S84 (state) Bool)
; set_to true
(assert (forall ((|ς| state) (|nondet::S84-0| (_ BitVec 8))) (=> (S83 |ς|) (S84 (update-state-s8 |ς| (object-address "main::$tmp::return_value_subseq") |nondet::S84-0|)))))

; find_symbols
(declare-fun S85in (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S75 |ς|) (S85in |ς|))))

; set_to true
(assert (forall ((|ς| state)) (=> (S80 |ς|) (S85in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S85 |ς|) (S86 (exit-scope-state-p64 |ς| (object-address "subseq::s"))))))

; find_symbols
(declare-fun S87 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S86 |ς|) (S87 (exit-scope-state-p64 |ς| (object-address "subseq::t"))))))

; find_symbols
(declare-fun S88 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S87 |ς|) (S88 (update-state-s8 |ς| (object-address "return'") (evaluate-s8 |ς| (object-address "main::$tmp::return_value_subseq")))))))

; find_symbols
(declare-fun S89 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S88 |ς|) (S89 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value_subseq"))))))

; find_symbols
(declare-fun S90 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S89 |ς|) (S90 (exit-scope-state-p64 |ς| (object-address "main::1::nondetString2"))))))

; find_symbols
(declare-fun S91 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S90 |ς|) (S91 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value_malloc$0"))))))

; find_symbols
(declare-fun S92 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S91 |ς|) (S92 (exit-scope-state-p64 |ς| (object-address "main::1::nondetString1"))))))

; find_symbols
(declare-fun S93 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S92 |ς|) (S93 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value_malloc"))))))

; find_symbols
(declare-fun S94 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S93 |ς|) (S94 (exit-scope-state-p64 |ς| (object-address "main::1::length2"))))))

; find_symbols
(declare-fun S95 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S94 |ς|) (S95 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value___VERIFIER_nondet_char$0"))))))

; find_symbols
(declare-fun S96 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S95 |ς|) (S96 (exit-scope-state-p64 |ς| (object-address "main::1::length1"))))))

; find_symbols
(declare-fun S97 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S96 |ς|) (S97 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value___VERIFIER_nondet_char"))))))
