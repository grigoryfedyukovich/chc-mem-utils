...
; set_to true
(assert (forall ((|ς| state)) (=> (S44 |ς|) (S45 (enter-scope-state-p64 |ς| (object-address "cstrncpy::dst") (_ bv8 64))))))

; find_symbols
(declare-fun S46 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S45 |ς|) (S46 (update-state-p64 |ς| (object-address "cstrncpy::dst") (evaluate-p64 |ς| (object-address "main::1::nondetArea")))))))

; find_symbols
(declare-fun S47 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S46 |ς|) (S47 (enter-scope-state-p64 |ς| (object-address "cstrncpy::src") (_ bv8 64))))))

; find_symbols
(declare-fun S48 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S47 |ς|) (S48 (update-state-p64 |ς| (object-address "cstrncpy::src") (evaluate-p64 |ς| (object-address "main::1::nondetString")))))))

; find_symbols
(declare-fun S49 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S48 |ς|) (S49 (enter-scope-state-p64 |ς| (object-address "cstrncpy::n") (_ bv8 64))))))

; find_symbols
(declare-fun S50 (state) Bool)
(declare-fun update-state-u64 (state (_ BitVec 64) (_ BitVec 64)) state)
; set_to true
(assert (forall ((|ς| state)) (=> (S49 |ς|) (S50 (update-state-u64 |ς| (object-address "cstrncpy::n") ((_ sign_extend 56) (evaluate-s8 |ς| (object-address "main::1::n"))))))))

(declare-fun evaluate-u64 (state (_ BitVec 64)) (_ BitVec 64))
; find_symbols
(declare-fun S51T (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S50 |ς|) (not (not (= (evaluate-u64 |ς| (object-address "cstrncpy::n")) ((_ sign_extend 32) (_ bv0 32)))))) (S51T |ς|))))

; find_symbols
(declare-fun S51 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S50 |ς|) (not (= (evaluate-u64 |ς| (object-address "cstrncpy::n")) ((_ sign_extend 32) (_ bv0 32))))) (S51 |ς|))))

; find_symbols
(declare-fun S52 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S51 |ς|) (S52 (enter-scope-state-p64 |ς| (object-address "cstrncpy::1::1::d") (_ bv8 64))))))

; find_symbols
(declare-fun S53 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S52 |ς|) (S53 (update-state-p64 |ς| (object-address "cstrncpy::1::1::d") (evaluate-p64 |ς| (object-address "cstrncpy::dst")))))))

; find_symbols
(declare-fun S54 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S53 |ς|) (S54 (enter-scope-state-p64 |ς| (object-address "cstrncpy::1::1::s") (_ bv8 64))))))

; find_symbols
(declare-fun S55 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S54 |ς|) (S55 (update-state-p64 |ς| (object-address "cstrncpy::1::1::s") (evaluate-p64 |ς| (object-address "cstrncpy::src")))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S84T |ς|) (S56in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S56in |ς|) (S56 (enter-scope-state-p64 |ς| (object-address "cstrncpy::$tmp::tmp_post_d$0") (_ bv8 64))))))

; find_symbols
(declare-fun S57 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S56 |ς|) (S57 (update-state-p64 |ς| (object-address "cstrncpy::$tmp::tmp_post_d$0") (evaluate-p64 |ς| (object-address "cstrncpy::1::1::d")))))))

; find_symbols
(declare-fun S58 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S57 |ς|) (S58 (update-state-p64 |ς| (object-address "cstrncpy::1::1::d") (bvadd (evaluate-p64 |ς| (object-address "cstrncpy::1::1::d")) (_ bv1 64)))))))

; find_symbols
(declare-fun S59 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S58 |ς|) (S59 (enter-scope-state-p64 |ς| (object-address "cstrncpy::$tmp::tmp_post_s") (_ bv8 64))))))

; find_symbols
(declare-fun S60 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S59 |ς|) (S60 (update-state-p64 |ς| (object-address "cstrncpy::$tmp::tmp_post_s") (evaluate-p64 |ς| (object-address "cstrncpy::1::1::s")))))))

; find_symbols
(declare-fun S61 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S60 |ς|) (S61 (update-state-p64 |ς| (object-address "cstrncpy::1::1::s") (bvadd (evaluate-p64 |ς| (object-address "cstrncpy::1::1::s")) (_ bv1 64)))))))

; find_symbols
(declare-fun S62 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S61 |ς|) (S62 (enter-scope-state-p64 |ς| (object-address "cstrncpy::$tmp::tmp_assign") (_ bv1 64))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S63 |ς|) (S64 (update-state-s8 |ς| (object-address "cstrncpy::$tmp::tmp_assign") (evaluate-s8 |ς| (evaluate-p64 |ς| (object-address "cstrncpy::$tmp::tmp_post_s"))))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S65 |ς|) (S66 (update-state-s8 |ς| (evaluate-p64 |ς| (object-address "cstrncpy::$tmp::tmp_post_d$0")) (evaluate-s8 |ς| (object-address "cstrncpy::$tmp::tmp_assign")))))))

; find_symbols
(declare-fun S67T (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S66 |ς|) (not (= ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "cstrncpy::$tmp::tmp_assign"))) (_ bv0 32)))) (S67T |ς|))))

; find_symbols
(declare-fun S67 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S66 |ς|) (= ((_ sign_extend 24) (evaluate-s8 |ς| (object-address "cstrncpy::$tmp::tmp_assign"))) (_ bv0 32))) (S67 |ς|))))

; find_symbols
(declare-fun S75 (state) Bool)
; find_symbols
(declare-fun S68in (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S75 |ς|) (S68in |ς|))))

; set_to true
(assert (forall ((|ς| state)) (=> (S67 |ς|) (S68in |ς|))))

; find_symbols
(declare-fun S68 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S68in |ς|) (S68 (update-state-u64 |ς| (object-address "cstrncpy::n") (bvsub (evaluate-u64 |ς| (object-address "cstrncpy::n")) (_ bv1 64)))))))

; find_symbols
(declare-fun S69T (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S68 |ς|) (not (not (= (evaluate-u64 |ς| (object-address "cstrncpy::n")) ((_ sign_extend 32) (_ bv0 32)))))) (S69T |ς|))))

; find_symbols
(declare-fun S69 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S68 |ς|) (not (= (evaluate-u64 |ς| (object-address "cstrncpy::n")) ((_ sign_extend 32) (_ bv0 32))))) (S69 |ς|))))

; find_symbols
(declare-fun S70 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S69 |ς|) (S70 (enter-scope-state-p64 |ς| (object-address "cstrncpy::$tmp::tmp_post_d") (_ bv8 64))))))

; find_symbols
(declare-fun S71 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S70 |ς|) (S71 (update-state-p64 |ς| (object-address "cstrncpy::$tmp::tmp_post_d") (evaluate-p64 |ς| (object-address "cstrncpy::1::1::d")))))))

; find_symbols
(declare-fun S72 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S71 |ς|) (S72 (update-state-p64 |ς| (object-address "cstrncpy::1::1::d") (bvadd (evaluate-p64 |ς| (object-address "cstrncpy::1::1::d")) (_ bv1 64)))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S73 |ς|) (S74 (update-state-s8 |ς| (evaluate-p64 |ς| (object-address "cstrncpy::$tmp::tmp_post_d")) ((_ extract 7 0) (_ bv0 32)))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S76 |ς|) (S77 (exit-scope-state-p64 |ς| (object-address "cstrncpy::$tmp::tmp_post_d"))))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S79 |ς|) (S80 (exit-scope-state-p64 |ς| (object-address "cstrncpy::$tmp::tmp_assign"))))))

; find_symbols
(declare-fun S81 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S80 |ς|) (S81 (exit-scope-state-p64 |ς| (object-address "cstrncpy::$tmp::tmp_post_s"))))))

; find_symbols
(declare-fun S82 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S81 |ς|) (S82 (exit-scope-state-p64 |ς| (object-address "cstrncpy::$tmp::tmp_post_d$0"))))))

; find_symbols
(declare-fun S83 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S82 |ς|) (S83 (update-state-u64 |ς| (object-address "cstrncpy::n") (bvsub (evaluate-u64 |ς| (object-address "cstrncpy::n")) (_ bv1 64)))))))

; set_to true
(assert (forall ((|ς| state)) (=> (and (S83 |ς|) (not (= (evaluate-u64 |ς| (object-address "cstrncpy::n")) ((_ sign_extend 32) (_ bv0 32))))) (S84T |ς|))))

; find_symbols
(declare-fun S84 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (and (S83 |ς|) (not (not (= (evaluate-u64 |ς| (object-address "cstrncpy::n")) ((_ sign_extend 32) (_ bv0 32)))))) (S84 |ς|))))

; find_symbols
(declare-fun S85in (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S78 |ς|) (S85in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S85 |ς|) (S86 (exit-scope-state-p64 |ς| (object-address "cstrncpy::1::1::s"))))))

; find_symbols
(declare-fun S87 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S86 |ς|) (S87 (exit-scope-state-p64 |ς| (object-address "cstrncpy::1::1::d"))))))

; find_symbols
(declare-fun S88in (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S51T |ς|) (S88in |ς|))))
...
; set_to true
(assert (forall ((|ς| state)) (=> (S91 |ς|) (S92 (exit-scope-state-p64 |ς| (object-address "cstrncpy::dst"))))))

; find_symbols
(declare-fun S93 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S92 |ς|) (S93 (exit-scope-state-p64 |ς| (object-address "cstrncpy::src"))))))

; find_symbols
(declare-fun S94 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S93 |ς|) (S94 (exit-scope-state-p64 |ς| (object-address "cstrncpy::n"))))))

; find_symbols
(declare-fun S95 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S94 |ς|) (S95 (update-state-s8 |ς| (object-address "return'") ((_ extract 7 0) (_ bv0 32)))))))

; find_symbols
(declare-fun S96 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S95 |ς|) (S96 (exit-scope-state-p64 |ς| (object-address "main::1::nondetString"))))))

; find_symbols
(declare-fun S97 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S96 |ς|) (S97 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value_malloc$0"))))))

; find_symbols
(declare-fun S98 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S97 |ς|) (S98 (exit-scope-state-p64 |ς| (object-address "main::1::nondetArea"))))))

; find_symbols
(declare-fun S99 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S98 |ς|) (S99 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value_malloc"))))))

; find_symbols
(declare-fun S100 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S99 |ς|) (S100 (exit-scope-state-p64 |ς| (object-address "main::1::n"))))))

; find_symbols
(declare-fun S101 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S100 |ς|) (S101 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value___VERIFIER_nondet_char$0"))))))

; find_symbols
(declare-fun S102 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S101 |ς|) (S102 (exit-scope-state-p64 |ς| (object-address "main::1::length"))))))

; find_symbols
(declare-fun S103 (state) Bool)
; set_to true
(assert (forall ((|ς| state)) (=> (S102 |ς|) (S103 (exit-scope-state-p64 |ς| (object-address "main::$tmp::return_value___VERIFIER_nondet_char"))))))
